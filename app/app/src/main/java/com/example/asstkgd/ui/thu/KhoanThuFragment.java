            ...
            public void onClick(View v) {
                ...
                btn_add.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        KhoannThuDatabase.getInstance(getContext()).khoanThuDAA().insertKhoanThu(thu);
                        loadData();
                        listKhoanThu = KhoannThuDatabase.getInstance(getContext()).khoanThuDAA().getAll();
                        khoanThuAdapter.setData(listKhoanThu);
                        rcv_list.setAdapter(khoanThuAdapter);
    ...
    void deleteKhoanThu(KhoanThu khoanThu){
        new AlertDialog.Builder(getContext())
                ...
                .setPositiveButton("Có", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        KhoannThuDatabase.getInstance(getContext()).khoanThuDAA().delete(khoanThu);
    ...
    void updateKhoanThu(KhoanThu khoanThu){
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                KhoannThuDatabase.getInstance(getContext()).khoanThuDAA().updateKhoanThu(khoanThu);
                loadData();
                rcv_list.setAdapter(khoanThuAdapter);
                dialog.dismiss();
            }
