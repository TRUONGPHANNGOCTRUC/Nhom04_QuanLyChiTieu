...
public class ChiThongKe extends Fragment {
    private ImageView im_end, im_start;
    private TextView tv_end,tv_start,tv_size;
    private Button btn_search;
    private ChiThongKeViewModel mViewModel;


    public static ChiThongKe newInstance() {
        return new ChiThongKe();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_chi_thong_ke, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String start_day = tv_start.getText().toString().trim();
                String end_day = tv_end.getText().toString().trim();
                List<KhoanChi> khoanChiList = new ArrayList<>();
                khoanChiList = KhoanChiDatabase.getInstance(getContext()).khoanChiDAO().thongKe(start_day,end_day);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(ChiThongKeViewModel.class);
