...
public final class DialogUpdateKhoanThuBinding implements ViewBinding {
  @NonNull
  ...
  private DialogUpdateKhoanThuBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static DialogUpdateKhoanThuBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogUpdateKhoanThuBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_update_khoan_thu, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogUpdateKhoanThuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogUpdateKhoanThuBinding((LinearLayout) rootView, btnAdd, btnExit, datePicker,
