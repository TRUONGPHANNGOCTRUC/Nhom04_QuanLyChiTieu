...
public final class DialogKhoanThuBinding implements ViewBinding {
  @NonNull
  ...
  private DialogKhoanThuBinding(@NonNull LinearLayout rootView, @NonNull AppCompatButton btnAdd,
  ...
  @NonNull
  public static DialogKhoanThuBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogKhoanThuBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_khoan_thu, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogKhoanThuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogKhoanThuBinding((LinearLayout) rootView, btnAdd, btnExit, datePicker,
