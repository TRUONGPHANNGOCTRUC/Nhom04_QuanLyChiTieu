...
public final class DiolagUpdateLoaiChiBinding implements ViewBinding {
  @NonNull
  ...
  private DiolagUpdateLoaiChiBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static DiolagUpdateLoaiChiBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DiolagUpdateLoaiChiBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.diolag_update_loai_chi, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DiolagUpdateLoaiChiBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DiolagUpdateLoaiChiBinding((LinearLayout) rootView, btnAdd, btnExit, edName);
    }
